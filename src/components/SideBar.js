    ...
    <nav className="sidebar sidebar-offcanvas" id="sidebar">
      <ul className="nav">
        ...
        >
          <div
            className={
              this.state.basicUiMenuOpen ? "nav-link menu-expanded" : "nav-link"
            }
        ...
        <li
          className={
            this.isPathActive("/form-elements") ? "nav-item active" : "nav-item"
          }
        >
          <div
            className={
        ...
        >
          <div
            className={
              this.state.tablesMenuOpen ? "nav-link menu-expanded" : "nav-link"
            }
        ...
        >
          <div
            className={
              this.state.chartsMenuOpen ? "nav-link menu-expanded" : "nav-link"
            }
        ...
        <li
          className={
            this.isPathActive("/general-pages") ? "nav-item active" : "nav-item"
          }
        >
          <div
            className={
